...
React + FastAPI 기반의 AI 게시판입니다. 기본 게시판 기능 위에 사용자별 연동 프로필, GitHub/Notion 중심 자동화, RAG, MCP, AI Agent, GitHub/Notion/Figma/Google Calendar write 검증을 자연스럽게 붙인 개인 과제용 구현입니다.
