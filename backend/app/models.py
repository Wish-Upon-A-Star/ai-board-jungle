...
class IntegrationProfile(Base):
    ...
    mcp_server_url: Mapped[str] = mapped_column(String(500), default="")
    mcp_auth_subject: Mapped[str] = mapped_column(String(160), default="")
    mcp_scopes_json: Mapped[str] = mapped_column(Text, default="[]")
